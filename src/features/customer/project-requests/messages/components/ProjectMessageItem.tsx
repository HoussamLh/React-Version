...
type Props = { message: CustomerProjectMessage };

export const ProjectMessageItem: React.FC<Props> = ({ message }) => (
  <div
    style={{
      ...styles.message,
      ...(message.senderType === "customer" ? styles.customer : styles.team),
    }}
  >
...
const styles = {
  message: { padding: spacing.md, borderRadius: radius.lg },
  customer: {
  ...
  sender: { color: colors.text.main, fontSize: "13px" },
  text: { color: colors.text.muted, lineHeight: "22px" },
  date: {
    display: "block",
